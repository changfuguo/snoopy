...
const {createState, stateFromOptions} = state;
const Engine = {
  runningAnimations: [],
  completedAnimations: [],
  ...
  archiveCompletedAnimations() {
    ...
    // console.log('unFinished:',unFinished.length, 'finished:' + finished.length)
    ...
    // console.log('this.completedAnimations:',this.completedAnimations.length)
